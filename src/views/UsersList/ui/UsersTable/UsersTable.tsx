...
import {UserType } from '@/shared/shared-types'
...
export const UsersTable = () => {
  ...
  const users:UserType[] = [
    {
      ...
      userBan: {
        reason: 'Bad behavior',
        createdAt: '2024-12-29T15:44:31.082Z'as ISOStringFormat,
      },
    },
    {
      id: 2,
      ...
      createdAt: '2023-11-15T15:55:31.082Z'as ISOStringFormat,
      userBan: null
    },
    {
      id: 3,
      ...
      createdAt: '2022-06-16T10:44:31.082Z'as ISOStringFormat,
      userBan: null
    },
    {
      id: 4,
      ...
      createdAt: '2023-01-22T07:55:31.082Z'as ISOStringFormat,
      userBan: null
    },
    {
      id: 5,
      ...
      createdAt: '2024-02-06T16:33:31.082Z'as ISOStringFormat,
      userBan: null
    },
    {
      id: 6,
      ...
      createdAt: '2023-08-07T17:52:31.082Z'as ISOStringFormat,
      userBan: null
    },
    {
      id: 7,
      ...
      createdAt: '2023-02-01T12:34:31.082Z'as ISOStringFormat,
      userBan: null
    },
    {
      id: 8,
      ...
      createdAt: '2021-07-12T02:44:31.082Z'as ISOStringFormat,
      userBan: null
    },
    {
      id: 9,
  ...
  if (users) {
    ...
    while (i <= page * itemsCount - 1 && i < users.length) {
      ...
      shownUsers.push(<TableUserItem key={users[i].id} user={users[i]} profileLink={profileLink} />)
      i++
    }
  }
